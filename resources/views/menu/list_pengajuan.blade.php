  ...
  <div class="main">
    <div class="main-content">
          ...
          <div class="col-md-12">
                ...
                <form class="" action="/r_search_list_opini" method="get" role="search">
                ...
                @if (session()->has('s_list_user'))
                  <div class="table-responsive">
                        ...
                        @foreach ($listpengajuan as $row)
                          <tr>
                            <td style="text-align:center" nowrap><button style="width:80px;" onclick="location.href='/edit_pengajuan/edit/{{ $row->Id }}';" class="btn btn-primary">Edit</button>   <button style="width:80px;" onclick="window.location='/edit_pengajuan/delete/{{ $row->Id }}';" class="btn btn-warning">Delete</button>  </td>
