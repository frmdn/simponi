    ...
    <div class="row">
      <div class="col-md-12">
       ...
       <div class="panel-body">
        <form class="" action="/r_search_list_opini_all_view" method="get" role="search">
        ...
        <div class="text-center" style="margin-bottom: 10px;">
          <button type="button" class="btn btn-success btn-toastr" data-context="info" data-message="This is general theme info" data-position="top-right">Download</button>
        </div>
        ...
        <tbody>
          ...
          <tr>
            {{-- <td style="text-align:center" nowrap><button class="btn btn-success">Download</button>  </td> --}}
